...
class VersionUpdateController extends Controller
{
    ...
    public function processUpdate(Request $request)
    {
        ...
        try {
            ...
            return Redirect::back()->withErrors(['purchase_code' => __('Could not reach the update server. Please check your internet connection.')]);
        }
    ...
    public function versionFileUpdate(Request $request)
    {
        ...
        try {
            ...
            $data['latestBuildVersion'] = null;
            $data['addons']             = [];
            $data['connectionError']    = __('Could not reach the update server. Please check your internet connection and try again.');
            $apiResponse = null;
        }

        if ($apiResponse && $apiResponse->successful()) {
            $responseData = $apiResponse->object();
            $data['latestVersion']      = $responseData->data->cv  ?? null;
            $data['latestBuildVersion'] = $responseData->data->bv  ?? null;
            $data['addons']             = $responseData->data->addons ?? [];
        } elseif ($apiResponse) {
            $data['latestVersion']      = null;
            $data['latestBuildVersion'] = null;
            $data['addons']             = [];
            $data['connectionError']    = __('Something went wrong contacting the update server.');
        }
