                    ...
                    <div class="modal-body">
                        <div class="modal-inner-form-box bg-off-white theme-border radius-4 p-20 mb-20 pb-0">
                            ...
                            <div class="row">
                                ...
                                {{-- Monthly: months per invoice --}}
                                <div class="col-md-6 mb-25 d-none months_covered_field">
                                    <label
                                        class="label-text-title color-heading font-medium mb-2">{{ __('Months Per Invoice') }}</label>
                                    <select class="form-select flex-shrink-0" name="months_covered">
                                        <option value="1">{{ __('1 Month (Monthly)') }}</option>
                                        <option value="2">{{ __('2 Months (Bi-Monthly)') }}</option>
                                        <option value="3">{{ __('3 Months (Quarterly)') }}</option>
                                        <option value="6">{{ __('6 Months (Semi-Annual)') }}</option>
                                        <option value="12">{{ __('12 Months (Annual)') }}</option>
                                    </select>
                                    <small class="text-muted">{{ __('Invoice amount = item amount × months') }}</small>
                                </div>
                                {{-- Yearly: installments per year --}}
                                <div class="col-md-6 mb-25 d-none installments_field">
                                    <label
                                        class="label-text-title color-heading font-medium mb-2">{{ __('Installments Per Year') }}</label>
                                    <select class="form-select flex-shrink-0" name="installments_per_year">
                                        <option value="1">{{ __('1 (Full Year, Single Invoice)') }}</option>
                                        <option value="2">{{ __('2 (Semi-Annual)') }}</option>
                                        <option value="3">{{ __('3 (Every 4 Months)') }}</option>
                                        <option value="4">{{ __('4 (Quarterly)') }}</option>
                                        <option value="6">{{ __('6 (Bi-Monthly)') }}</option>
                                        <option value="12">{{ __('12 (Monthly Installments)') }}</option>
                                    </select>
                                    <small class="text-muted">{{ __('Set item amounts to the per-installment value') }}</small>
                                </div>
                                <div class="col-md-6 mb-25">
                                    <label
