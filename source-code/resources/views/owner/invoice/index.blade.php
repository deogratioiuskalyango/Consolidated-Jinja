                    ...
                    <div class="modal-body">
                        <div class="modal-inner-form-box bg-off-white theme-border radius-4 p-20 mb-20 pb-0">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-25">
                                    <label
                                        class="label-text-title color-heading font-medium mb-2">{{ __('Starting Month') }}</label>
                                ...
                                <div class="col-md-6 mb-25">
                                    <label
                                        class="label-text-title color-heading font-medium mb-2">{{ __('Months Covered') }}</label>
                                    <select class="form-select flex-shrink-0" name="months_covered">
                                        ...
                                        <option value="12">{{ __('12 Months (Full Year)') }}</option>
                                    </select>
                                    <small class="text-muted">{{ __('Amount per item × months covered') }}</small>
                                </div>
                                <div class="col-md-6 mb-25">
                                    <label
...
{{--    <script src="{{ asset('assets/js/custom/invoice.js') }}"></script>--}}
    ...
    <script>
        ...
        function getDataEditRes(response) {
            ...
            var monthVal = response.data.invoice.month;
            var knownMonths = @json(array_values(month()));
            if (!knownMonths.includes(monthVal)) monthVal = knownMonths[0];
            selector.find('select[name=month]').val(monthVal)
