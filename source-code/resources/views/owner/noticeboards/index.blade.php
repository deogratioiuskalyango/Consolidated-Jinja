    ...
    <div class="modal fade" id="viewNoticeBoardDetailsModal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-start">
                    <button type="button"
                            class="btn btn-sm btn-outline-success notice-share-btn"
                            title="{{ __('Share this notice') }}">
                        <i class="ri-share-forward-2-line me-1"></i>{{ __('Share') }}
                    </button>
...
@push('script')
    ...
    <script>
    // Share button inside the view-notice modal
    $(document).on('click', '.notice-share-btn', function () {
        var title   = $('#viewNoticeBoardDetailsModal .viewtitle').text().trim();
        var details = $('#viewNoticeBoardDetailsModal .details').text().trim();
        var text    = details || title;
        openShareModal(title, text, window.location.href);
    });
    </script>
@endpush
