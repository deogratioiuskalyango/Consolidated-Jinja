...
<style>
    ...
    [data-bs-theme="dark"] .auth-notice i {
        color: #a5b4fc;
    }
        ...
        <div class="auth-form-panel">
            <div class="auth-inner">
                ...
                <div class="auth-notice">
                    ...
                    <span>{{ __('This is a secure area of the application. Please confirm your password before proceeding.') }}</span>
                </div>
                ...
                <form method="POST" action="{{ route('password.confirm') }}">
                    ...
                    <div class="auth-field-wrap">
                        <label class="auth-label" for="cp-password">{{ __('Password') }}</label>
