    ...
    <div class="auth-split">
        ...
        <div class="auth-form-panel">
            <div class="auth-inner">
                ...
                <p class="auth-subtitle">{{ __('No worries. Enter your email and we\'ll send you a reset link.') }}</p>
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="auth-field-wrap">
                        <label class="auth-label" for="fp-email">{{ __('Email Address') }}</label>
                        <input type="email"
                               id="fp-email"
                               name="email"
