                            ...
                            @if (!empty($connectionError))
                                <div class="col-sm-12 mb-3">
                                    <div class="alert alert-warning">
                                        <i class="ri-wifi-off-line me-1"></i>
                                        {{ $connectionError }}
                                    </div>
                                </div>
                            @endif
                            @if (!empty($latestBuildVersion) && getCustomerCurrentBuildVersion() == $latestBuildVersion)
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-responsive table-style table-sm table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!$latestBuildVersion || getCustomerCurrentBuildVersion() == $latestBuildVersion)
