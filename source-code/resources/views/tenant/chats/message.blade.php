            ...
            <div class="chat-wrapper">
                ...
                <div class="chat-sidebar" id="chat-sidebar">
                    ...
                    <div class="chat-user-list" id="chat-user-list">
                        @include('tenant.chats.chat-user-list')
                    </div>
                </div>
...
<script>
    window.CHAT_ROUTES = {
        single_user_chat: "{{ route('tenant.chats.single_user_chat') }}",
        send_message:     "{{ route('tenant.chats.send_message') }}",
        poll:             "{{ route('tenant.chats.poll') }}",
        typing:           "{{ route('tenant.chats.typing') }}",
        delete_message:   "{{ url('tenant/chats/delete/__ID__') }}",
        react:            "{{ url('tenant/chats/react/__ID__') }}",
        user_list:        "{{ route('tenant.chats.user_list') }}",
    };
