...
@foreach ($chats as $msg)
    ...
    <div class="chat-msg-row {{ $side }}" data-msg-id="{{ $msg['id'] }}" data-sender="{{ $msg['sender_id'] }}">
        ...
        <div class="msg-actions">
            <button class="msg-action-btn" data-action="reply" data-msg-id="{{ $msg['id'] }}"
                    data-msg-text="{{ $msg['message_type'] == 1 ? Str::limit($msg['message'], 60) : '📎 Attachment' }}">
                <i class="ri-reply-line"></i>
            </button>
            <button class="msg-action-btn" data-action="show-react" data-msg-id="{{ $msg['id'] }}">
                <i class="ri-emotion-line"></i>
            </button>
            @if($isMine)
            <button class="msg-action-btn text-danger" data-action="delete" data-msg-id="{{ $msg['id'] }}">
