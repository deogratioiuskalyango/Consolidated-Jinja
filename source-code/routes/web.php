...
Route::group(['middleware' => ['auth', 'version.update']], function () {
    ...
    Route::get('role-select', [RoleSelectController::class, 'index'])->name('role.select.index');
    Route::post('role-select', [RoleSelectController::class, 'select'])->name('role.select');
    Route::get('role-switch/{slug}', [RoleSelectController::class, 'switchTo'])->name('role.switch');
...
Route::group(['prefix' => 'payment'], function () {
    ...
    Route::get('pesapal/iframe/{order_id}', [PaymentController::class, 'pesapalIframe'])->name('payment.pesapal.iframe')->middleware('auth');
    Route::get('pesapal/ipn', [PaymentController::class, 'pesapalIpn'])->name('payment.pesapal.ipn');
});
