...
Route::group(['prefix' => 'tenant', 'as' => 'tenant.', 'middleware' => ['auth', 'tenant']], function () {
    ...
    Route::group(['prefix' => 'contracts', 'as' => 'contracts.'], function () {
        ...
        Route::post('{id}/review-clause', [ContractController::class, 'reviewClause'])->name('review-clause');
        Route::post('{id}/sign', [ContractController::class, 'sign'])->name('sign');
        Route::post('{id}/lc1-sign', [ContractController::class, 'lc1Sign'])->name('lc1-sign');
        Route::get('{id}/print', [ContractController::class, 'print'])->name('print');
    });
