...
Route::group(['prefix' => 'owner', 'as' => 'owner.', 'middleware' => ['auth', 'owner']], function () {
    ...
    Route::group(['prefix' => 'role-permission', 'as' => 'role-permission.'], function () {
        ...
        Route::get('user-assignments', [RolePermissionController::class, 'userAssignments'])->name('user-assignments');
        ...
        Route::get('users-for-assignment', [RolePermissionController::class, 'getUsersForAssignment'])->name('users-for-assignment');
    });
    ...
    Route::group(['prefix' => 'chats', 'as' => 'chats.'], function () {
        ...
        Route::post('delete/{id}', [MessageController::class, 'deleteMessage'])->name('delete_message');
        Route::post('react/{id}', [MessageController::class, 'react'])->name('react');
        Route::get('user-list', [MessageController::class, 'userList'])->name('user_list');
    });
