                ...
                <div class="flexbox-layout-section-primary mt-20">
                    ...
                    <div class="row mb-3 g-2">
                        ...
                        <x-core::stat-widget.item
                            ...
                            :value="format_price($totalCredits / 100)"
                        ...
                        <x-core::stat-widget.item
                            ...
                            :value="format_price($totalDebits / 100)"
                    ...
                    <div class="row mb-3 g-2">
                        ...
                        <x-core::stat-widget.item
                            ...
                            :value="format_price($pendingWithdrawalsAmount / 100)"
                            icon="ti ti-cash"
                            color="orange"
                            :url="route('e-wallet.withdrawals.index')"
                            column="col-12 col-sm-6 col-lg-4"
                        ...
                        <x-core::stat-widget.item
                            ...
                            :value="format_price($completedWithdrawalsAmount / 100)"
                            icon="ti ti-check"
                            color="green"
                            :url="route('e-wallet.withdrawals.index')"
                            column="col-12 col-sm-6 col-lg-4"
                        ...
                        <div class="col-12">
                            <x-core::card>
                                <x-core::card.body class="text-center py-4">
                                    ...
                                    <h2 class="mb-1 text-primary">{{ format_price($totalBalanceInCirculation / 100) }}</h2>
                                                    ...
                                                    <x-core::table.body.row>
                                                        ...
                                                        <x-core::table.body.cell class="text-end">
                                                            @php
                                                                ...
                                                                $prefix = $amount >= 0 ? '+' : '';
                                                            @endphp
                                                            <span class="{{ $class }} fw-semibold">{{ $prefix }}{{ format_price(abs($amount) / 100) }}</span>
                                                        </x-core::table.body.cell>
                                                    </x-core::table.body.row>
                                                @endforeach
                                            </x-core::table.body>
