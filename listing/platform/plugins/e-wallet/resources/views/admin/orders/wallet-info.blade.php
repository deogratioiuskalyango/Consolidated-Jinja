                ...
                <div class="col-6 p-3 border-end">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="fw-bold text-danger">{{ format_price(abs($totalPaid) / 100) }}</div>
                        </div>
                    </div>
                </div>
                <div class="col-6 p-3">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            ...
                            <div class="fw-bold text-success">{{ format_price($totalRefunded / 100) }}</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="list-group-item">
                    ...
                    <div class="d-flex justify-content-between align-items-end">
                        ...
                        <div @class([
                            ...
                            {{ $isDebit ? '-' : '+' }}{{ format_price(abs($amount) / 100) }}
                        </div>
                    </div>
                </div>
            @endforeach
