                                    ...
                                    <x-core::datagrid>
                                        ...
                                        <x-core::datagrid.item class="mb-3">
                                            ...
                                            @php
                                                ...
                                                $prefix = $amount >= 0 ? '+' : '';
                                            @endphp
                                            <span class="{{ $amountClass }} fw-bold fs-4">{{ $prefix }}{{ format_price(abs($amount) / 100) }}</span>
                                        </x-core::datagrid.item>
                                ...
                                <div class="col-12 col-md-6">
                                    <x-core::datagrid>
                                        <x-core::datagrid.item class="mb-3">
                                            ...
                                            <span class="text-muted">{{ format_price($transaction->balance_before / 100) }}</span>
                                        </x-core::datagrid.item>
                                        ...
                                        <x-core::datagrid.item class="mb-3">
                                            ...
                                            <span class="fw-semibold">{{ format_price($transaction->balance_after / 100) }}</span>
                                        </x-core::datagrid.item>
